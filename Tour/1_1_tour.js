        ...
        steps: [
          {
            id: "benvenuto",
            selector: "",
            content: "Benvenuto a Wagham Gildano! Ora sei pronto per iniziare la tua nuova avventura! Ma prima dovrai creare la sceda del tuo personaggio! vediamo come si fa..."
          },
          {
            selector: '.fa-users',
          ...
          },
          {
            ...
            content: "cliccando qui abbiamo a disposizione una pletora di risorse da cui attingere per la nostra classe, ma anoi interessa solo '5etools' e 'Wagham Compendium'"
          },
          {
